...
import ldrAutomationImage from "figma:asset/f6a1b2b207881aa8efad382e6090b7fab7e06ea0.png";
import obstacleDetectionImage from "figma:asset/aed4661ffaeefe304e6eac3c584079344b8802cb.png";
import portfolioImage from "figma:asset/e046239edfa56698b529a3278a88777621515b58.png";
import slamMappingImage from "figma:asset/c31eb28f330604a1fdaac207a6cbecbb8f1a8d43.png";
import surveillanceCarImage from "figma:asset/08a96e9fdb49bfff3a2626286afa95b244b86212.png";
import lineFollowingImage from "figma:asset/ea661812324719a45d2fa489769a8f140e4b7aca.png";
import roboSoccerImage from "figma:asset/2cd32d45cdc8cee681697ea6948ddefa01310ca0.png";
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <motion.a
                ...
                viewport={{ once: true }}
                className={`backdrop-blur-sm rounded-xl overflow-hidden hover:transform hover:scale-105 transition-transform duration-300 cursor-pointer ${
